...
- Use o comando: `git clone git@github.com:tryber/sd-025-a-project-delivery-app.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-025-a-project-delivery-app`
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-025-a-project-delivery-app/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-025-a-project-delivery-app/pulls) e confira que o seu _Pull Request_ está criado
...
## ESLint
  ...
  ➡️ Este projeto já vem com as dependências relacionadas ao _linter_ configuradas nos arquivos `package.json` nos seguintes caminhos:
    - `sd-025-a-project-delivery-app/back-end/package.json`
    - `sd-025-a-project-delivery-app/front-end/package.json`
...
<details>
  ...
  Link: [Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH25-A&template=betrybe/sd-0x-project-delivery-app)
